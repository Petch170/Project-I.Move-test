    ...
    <>
      ...
      <body class="flex h-screen">
        ...
        <div class="flex-1 h-full w-1/2 border-r-4 ">
          <div
            id="img"
            className="md:hidden flex items-center content-center items-center w-full h-full aspect-auto "
          >
            <img
        ...
        <img className="nav w-14 h-14" src="src\assets\Pic-home\logo1.png" alt="icon" /> <div className="pt-5 flex justify-center ">i-move</div></div>
          ...
          <div className="mt-3">
            <button
              type="summit"
              onClick={handleData}
              className="mr-5 border-2 border-indigo-600"
            >
              Login
            </button>
            <button type="reset" className="border-2 border-indigo-600">
              Clear
            </button>
          </div>
        </div>
