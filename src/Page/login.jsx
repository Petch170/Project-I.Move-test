...
function Login() {
  ...
  const handleData = async () => {
    ...
    // console.log(data);
    try {
      const resposedata = await axios.post("https://imovebackend.onrender.com/login", data);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        if (gettoken != null) {
          const response = await axios.post("https://imovebackend.onrender.com/data", lala);
